...
struct CPU {
	...
	void execute(u8 instruction) {
		switch(instruction) {
			...
			/* INC B       */ case 0x04:	inc_byte(regs.b);											pc++;	cycle(4);	break;
			/* DEC B       */ case 0x05:	dec_byte(regs.b);											pc++;	cycle(4);	break;
			/* LD B,d8     */ case 0x06:	regs.b = bus.read_byte(pc + 1);								pc+=2;	cycle(8);	break;
			/* RLCA        */ case 0x07:	rlca();														pc++;	cycle(4);	break;
			/* LD (a16),SP */ case 0x08:	bus.write_byte(bus.read_word(pc + 1), sp);					pc+=2;	cycle(20);	break;
			/* ADD HL,BC   */ case 0x09:	add_hl(regs.bc);											pc++;	cycle(8);	break;
			/* LD A,(BC)   */ case 0x0a:	regs.a = bus.read_byte(regs.bc);							pc++;	cycle(8);	break;
			/* DEC BC      */ case 0x0b:	regs.bc--;													pc++;	cycle(8);	break;
			/* INC C       */ case 0x0c:	inc_byte(regs.c);											pc++;	cycle(4);	break;
			/* DEC C       */ case 0x0d:	dec_byte(regs.c);											pc++;	cycle(4);	break;
			/* LD C,d8     */ case 0x0e:	regs.c = bus.read_byte(pc + 1);								pc+=2;	cycle(8);	break;
			/* RRCA        */ case 0x0f:	rrca();														pc++;	cycle(4);	break;
			/* STOP 0      */ case 0x10:	stopped = true;												pc++;	cycle(4);	break;
			/* LD DE,d16   */ case 0x11:	regs.de = bus.read_word_reverse(pc + 1);					pc+=3;	cycle(12);	break;
			/* LD (DE),A   */ case 0x12:	bus.write_byte(regs.de, regs.a);							pc++;	cycle(8);	break;
			/* INC DE      */ case 0x13:	regs.de++;													pc++;	cycle(8);	break;
			/* INC D       */ case 0x14:	inc_byte(regs.d);											pc++;	cycle(4);	break;
			/* DEC D       */ case 0x15:	dec_byte(regs.d);											pc++;	cycle(4);	break;
			/* LD D,d8     */ case 0x16:	regs.d = bus.read_byte(pc + 1);								pc+=2;	cycle(8);	break;
			/* RLA         */ case 0x17:	rla();														pc++;	cycle(4);	break;
			/* JR r8       */ case 0x18:	jr();																cycle(12);	break;
			/* ADD HL,DE   */ case 0x19:	add_hl(regs.de);											pc++;	cycle(8);	break;
			/* LD A,(DE)   */ case 0x1a:	regs.a = bus.read_byte(regs.de);							pc++;	cycle(8);	break;
			/* DEC DE      */ case 0x1b:	regs.de--;													pc++;	cycle(8);	break;
			/* INC E       */ case 0x1c:	inc_byte(regs.e);											pc++;	cycle(4);	break;
			/* DEC E       */ case 0x1d:	dec_byte(regs.e);											pc++;	cycle(4);	break;
			/* LD E,d8     */ case 0x1e:	regs.e = bus.read_byte(pc + 1);								pc+=2;	cycle(8);	break;
			/* RRA         */ case 0x1f:	rra();														pc++;	cycle(4);	break;
			/* JR NZ,r8    */ case 0x20:	if(regs.f.zero) { pc += 2; cycle(8); } else { jr(); cycle(12); }				break;
			/* LD HL,d16   */ case 0x21:	regs.hl = bus.read_word_reverse(pc + 1);					pc+=3;	cycle(12);	break;
			/* LD (HL+),A  */ case 0x22:	bus.write_byte(regs.hl++, regs.a);							pc++;	cycle(8);	break;
			/* INC HL      */ case 0x23:	regs.hl++;													pc++;	cycle(8);	break;
			/* INC H       */ case 0x24:	inc_byte(regs.h);											pc++;	cycle(4);	break;
			/* DEC H       */ case 0x25:	dec_byte(regs.h);											pc++;	cycle(4);	break;
			/* LD H,d8     */ case 0x26:	regs.h = bus.read_byte(pc + 1);								pc+=2;	cycle(8);	break;
			/* DAA         */ case 0x27:	daa();														pc++;	cycle(4);	break;
			/* JR Z,r8     */ case 0x28:	if(regs.f.zero) {jr(); cycle(12); } else { pc += 2; cycle(8); }					break;
			/* ADD HL,HL   */ case 0x29:	add_hl(regs.hl);											pc++;	cycle(8);	break;
			/* LD A,(HL+)  */ case 0x2a:	regs.a = bus.read_byte(regs.hl++);							pc++;	cycle(8);	break;
			/* DEC HL      */ case 0x2b:	regs.hl--;													pc++;	cycle(8);	break;
			/* INC L       */ case 0x2c:	inc_byte(regs.l);											pc++;	cycle(4);	break;
			/* DEC L       */ case 0x2d:	dec_byte(regs.l);											pc++;	cycle(4);	break;
			/* LD L,d8     */ case 0x2e:	regs.l = bus.read_byte(pc + 1);								pc+=2;	cycle(8);	break;
			/* CPL         */ case 0x2f:	cpl();														pc++;	cycle(4);	break;
			/* JR NC,r8    */ case 0x30:	if(regs.f.carry) { pc += 2; cycle(8); } else { jr(); cycle(12); }				break;
			/* LD SP,d16   */ case 0x31:	sp = bus.read_word_reverse(pc + 1);							pc+=3;	cycle(12);	break;
			/* LD (HL-),A  */ case 0x32:	bus.write_byte(regs.hl--, regs.a);							pc++;	cycle(8);	break;
			/* INC SP      */ case 0x33:	sp++;														pc++;	cycle(8);	break;
			/* INC (HL)    */ case 0x34:	inc_byte(bus.read_byte(regs.hl));							pc++;	cycle(12);	break;
			/* DEC (HL)    */ case 0x35:	dec_byte(bus.read_byte(regs.hl));							pc++;	cycle(12);	break;
			/* LD (HL),d8  */ case 0x36:	bus.write_byte(regs.hl, bus.read_byte(pc + 1));				pc+=2;	cycle(12);	break;
			/* SCF         */ case 0x37:	scf();														pc++;	cycle(4);	break;
			/* JR C,r8     */ case 0x38:	if(regs.f.carry) { jr(); cycle(12); } else { pc += 2; cycle(8); }				break;
			/* ADD HL,SP   */ case 0x39:	add_hl(sp);													pc++;	cycle(8);	break;
			/* LD A,(HL-)  */ case 0x3a:	regs.a = bus.read_byte(regs.hl--);							pc++;	cycle(8);	break;
			/* DEC SP      */ case 0x3b:	sp--;														pc++;	cycle(8);	break;
			/* INC A       */ case 0x3c:	inc_byte(regs.a);											pc++;	cycle(4);	break;
			...
			/* LD B,H      */ case 0x44:	regs.b = regs.h;											pc++;	cycle(4);	break;
			/* LD B,L      */ case 0x45:	regs.b = regs.l;											pc++;	cycle(4);	break;
			...
			/* LD C,L      */ case 0x4d:	regs.c = regs.l;											pc++;	cycle(4);	break;
			/* LD C,(HL)   */ case 0x4e:	regs.c = bus.read_byte(regs.hl);							pc++;	cycle(8);	break;
			...
			/* LD D,(HL)   */ case 0x56:	regs.d = bus.read_byte(regs.hl);							pc++;	cycle(8);	break;
			/* LD D,A      */ case 0x57:	regs.d = regs.a;											pc++;	cycle(4);	break;
			...
			/* LD E,A      */ case 0x5f:	regs.e = regs.a;											pc++;	cycle(4);	break;
			/* LD H,B      */ case 0x60:	regs.h = regs.b;											pc++;	cycle(4);	break;
			/* LD H,C      */ case 0x61:	regs.h = regs.c;											pc++;	cycle(4);	break;
			/* LD H,D      */ case 0x62:	regs.h = regs.d;											pc++;	cycle(4);	break;
			/* LD H,E      */ case 0x63:	regs.h = regs.e;											pc++;	cycle(4);	break;
			/* LD H,H      */ case 0x64:	regs.h = regs.h;											pc++;	cycle(4);	break;
			/* LD H,L      */ case 0x65:	regs.h = regs.l;											pc++;	cycle(4);	break;
			/* LD H,(HL)   */ case 0x66:	regs.h = bus.read_byte(regs.hl);							pc++;	cycle(8);	break;
			/* LD H,A      */ case 0x67:	regs.h = regs.a;											pc++;	cycle(4);	break;
			/* LD L,B      */ case 0x68:	regs.l = regs.b;											pc++;	cycle(4);	break;
			/* LD L,C      */ case 0x69:	regs.l = regs.c;											pc++;	cycle(4);	break;
			...
			/* LD (HL),C   */ case 0x71:	bus.write_byte(regs.hl, regs.c);							pc++;	cycle(8);	break;
			/* LD (HL),D   */ case 0x72:	bus.write_byte(regs.hl, regs.d);							pc++;	cycle(8);	break;
			/* LD (HL),E   */ case 0x73:	bus.write_byte(regs.hl, regs.e);							pc++;	cycle(8);	break;
			/* LD (HL),H   */ case 0x74:	bus.write_byte(regs.hl, regs.h);							pc++;	cycle(8);	break;
			/* LD (HL),L   */ case 0x75:	bus.write_byte(regs.hl, regs.l);							pc++;	cycle(8);	break;
			/* HALT        */ case 0x76:	halted = true;												pc++;	cycle(4);	break;
			/* LD (HL),A   */ case 0x77:	bus.write_byte(regs.hl, regs.a);							pc++;	cycle(8);	break;
			/* LD A,B      */ case 0x78:	regs.a = regs.b;											pc++;	cycle(4);	break;
			/* LD A,C      */ case 0x79:	regs.a = regs.c;											pc++;	cycle(4);	break;
			/* LD A,D      */ case 0x7a:	regs.a = regs.d;											pc++;	cycle(4);	break;
			/* LD A,E      */ case 0x7b:	regs.a = regs.e;											pc++;	cycle(4);	break;
			...
			/* ADD A,E     */ case 0x83:	add_a(regs.e);												pc++;	cycle(4);	break;
			/* ADD A,H     */ case 0x84:	add_a(regs.h);												pc++;	cycle(4);	break;
			/* ADD A,L     */ case 0x85:	add_a(regs.l);												pc++;	cycle(4);	break;
			/* ADD A,(HL)  */ case 0x86:	add_a(bus.read_byte(regs.hl));								pc++;	cycle(8);	break;
			/* ADD A,A     */ case 0x87:	add_a(regs.a);												pc++;	cycle(4);	break;
			/* ADC A,B     */ case 0x88:	adc_a(regs.b);												pc++;	cycle(4);	break;
			/* ADC A,C     */ case 0x89:	adc_a(regs.c);												pc++;	cycle(4);	break;
			/* ADC A,D     */ case 0x8a:	adc_a(regs.d);												pc++;	cycle(4);	break;
			/* ADC A,E     */ case 0x8b:	adc_a(regs.e);												pc++;	cycle(4);	break;
			/* ADC A,H     */ case 0x8c:	adc_a(regs.h);												pc++;	cycle(4);	break;
			/* ADC A,L     */ case 0x8d:	adc_a(regs.l);												pc++;	cycle(4);	break;
			/* ADC A,(HL)  */ case 0x8e:	adc_a(bus.read_byte(regs.hl));								pc++;	cycle(8);	break;
			/* ADC A,A     */ case 0x8f:	adc_a(regs.a);												pc++;	cycle(4);	break;
			/* SUB B       */ case 0x90:	sub_a(regs.b);												pc++;	cycle(4);	break;
			/* SUB C       */ case 0x91:	sub_a(regs.c);												pc++;	cycle(4);	break;
			/* SUB D       */ case 0x92:	sub_a(regs.d);												pc++;	cycle(4);	break;
			/* SUB E       */ case 0x93:	sub_a(regs.e);												pc++;	cycle(4);	break;
			/* SUB H       */ case 0x94:	sub_a(regs.h);												pc++;	cycle(4);	break;
			/* SUB L       */ case 0x95:	sub_a(regs.l);												pc++;	cycle(4);	break;
			/* SUB (HL)    */ case 0x96:	sub_a(bus.read_byte(regs.hl));								pc++;	cycle(8);	break;
			/* SUB A       */ case 0x97:	sub_a(regs.a);												pc++;	cycle(4);	break;
			/* SBC A,B     */ case 0x98:	sbc_a(regs.b);												pc++;	cycle(4);	break;
			/* SBC A,C     */ case 0x99:	sbc_a(regs.c);												pc++;	cycle(4);	break;
			/* SBC A,D     */ case 0x9a:	sbc_a(regs.d);												pc++;	cycle(4);	break;
			/* SBC A,E     */ case 0x9b:	sbc_a(regs.e);												pc++;	cycle(4);	break;
			/* SBC A,H     */ case 0x9c:	sbc_a(regs.h);												pc++;	cycle(4);	break;
			/* SBC A,L     */ case 0x9d:	sbc_a(regs.l);												pc++;	cycle(4);	break;
			/* SBC A,(HL)  */ case 0x9e:	sbc_a(bus.read_byte(regs.hl));								pc++;	cycle(8);	break;
			/* SBC A,A     */ case 0x9f:	sbc_a(regs.a);												pc++;	cycle(4);	break;
			/* AND B       */ case 0xa0:	and_a(regs.b);												pc++;	cycle(4);	break;
			/* AND C       */ case 0xa1:	and_a(regs.c);												pc++;	cycle(4);	break;
			/* AND D       */ case 0xa2:	and_a(regs.d);												pc++;	cycle(4);	break;
			/* AND E       */ case 0xa3:	and_a(regs.e);												pc++;	cycle(4);	break;
			/* AND H       */ case 0xa4:	and_a(regs.h);												pc++;	cycle(4);	break;
			/* AND L       */ case 0xa5:	and_a(regs.l);												pc++;	cycle(4);	break;
			/* AND (HL)    */ case 0xa6:	and_a(bus.read_byte(regs.hl));								pc++;	cycle(8);	break;
			/* AND A       */ case 0xa7:	and_a(regs.a);												pc++;	cycle(4);	break;
			/* XOR B       */ case 0xa8:	xor_a(regs.b);												pc++;	cycle(4);	break;
			/* XOR C       */ case 0xa9:	xor_a(regs.c);												pc++;	cycle(4);	break;
			/* XOR D       */ case 0xaa:	xor_a(regs.d);												pc++;	cycle(4);	break;
			/* XOR E       */ case 0xab:	xor_a(regs.e);												pc++;	cycle(4);	break;
			/* XOR H       */ case 0xac:	xor_a(regs.h);												pc++;	cycle(4);	break;
			/* XOR L       */ case 0xad:	xor_a(regs.l);												pc++;	cycle(4);	break;
			/* XOR (HL)    */ case 0xae:	xor_a(bus.read_byte(regs.hl));								pc++;	cycle(8);	break;
			/* XOR A       */ case 0xaf:	xor_a(regs.a);												pc++;	cycle(4);	break;
			/* OR B        */ case 0xb0:	or_a(regs.b);												pc++;	cycle(4);	break;
			/* OR C        */ case 0xb1:	or_a(regs.c);												pc++;	cycle(4);	break;
			/* OR D        */ case 0xb2:	or_a(regs.d);												pc++;	cycle(4);	break;
			/* OR E        */ case 0xb3:	or_a(regs.e);												pc++;	cycle(4);	break;
			/* OR H        */ case 0xb4:	or_a(regs.h);												pc++;	cycle(4);	break;
			/* OR L        */ case 0xb5:	or_a(regs.l);												pc++;	cycle(4);	break;
			/* OR (HL)     */ case 0xb6:	or_a(bus.read_byte(regs.hl));								pc++;	cycle(8);	break;
			/* OR A        */ case 0xb7:	or_a(regs.a);												pc++;	cycle(4);	break;
			/* CP B        */ case 0xb8:	cp(regs.b);													pc++;	cycle(4);	break;
			/* CP C        */ case 0xb9:	cp(regs.c);													pc++;	cycle(4);	break;
			/* CP D        */ case 0xba:	cp(regs.d);													pc++;	cycle(4);	break;
			/* CP E        */ case 0xbb:	cp(regs.e);													pc++;	cycle(4);	break;
			/* CP H        */ case 0xbc:	cp(regs.h);													pc++;	cycle(4);	break;
			/* CP L        */ case 0xbd:	cp(regs.l);													pc++;	cycle(4);	break;
			/* CP (HL)     */ case 0xbe:	cp(bus.read_byte(regs.hl));									pc++;	cycle(8);	break;
			/* CP A        */ case 0xbf:	cp(regs.a);													pc++;	cycle(4);	break;
			/* RET NZ      */ case 0xc0:	if(regs.f.zero) pc++; else pc = pop();								cycle();	break;
			/* POP BC      */ case 0xc1:	regs.bc = pop();											pc++;	cycle(12);	break;
			/* JP NZ,a16   */ case 0xc2:	if(regs.f.zero) pc += 3; else pc = bus.read_word(pc + 1);			cycle();	break;
			/* JP a16      */ case 0xc3:	pc = bus.read_word(pc + 1);											cycle(16);	break;
			/* CALL NZ,a16 */ case 0xc4:	if(regs.f.zero) pc += 3; else call();								cycle();	break;
			/* PUSH BC     */ case 0xc5:	push(regs.bc);												pc++;	cycle(16);	break;
			/* ADD A,d8    */ case 0xc6:	add_a(bus.read_byte(pc + 1));								pc+=2;	cycle(8);	break;
			/* RST 00H     */ case 0xc7:	push(pc);													pc=0;	cycle(16);	break;
			...
			/* RST 08H     */ case 0xcf:	push(pc);													pc=8;	cycle(16);	break;
			...
			/* RST 10H     */ case 0xd7:	push(pc);													pc=16;	cycle(16);	break;
			...
			/* LD HL,SP+r8 */ case 0xf8:	ldhlspr8();													pc+=2;	cycle(12);	break;
